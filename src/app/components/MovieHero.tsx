  ...
  return (
    <div className="w-full">
      <div className="relative overflow-hidden dark:bg-zinc-950 lg:bg-transparent">
        {/* IMAGE */}
        <div
          className="relative h-[220px] sm:h-[320px] lg:h-[520px] xl:h-[600px] bg-cover bg-center"
          style={{
            backgroundImage: `url(${baseImgUrl + imgPath})`,
          }}
        >
          {/* overlay gradient (desktop) */}
          <div className="hidden lg:absolute lg:inset-0 lg:block lg:bg-gradient-to-r lg:from-black/85 lg:via-black/55 lg:to-black/10" />
          {/* overlay (mobile) */}
        ...
        <div className="p-4 sm:p-6 lg:absolute lg:inset-0 lg:flex lg:items-center lg:p-10">
          <div className="max-w-[560px]">
            ...
            {/* ONE BUTTON: icon + text (opens trailer modal) */}
